            ...
            <div className="row align-items-center row_pad">
                ...
                <div className="col-lg-6 col-md-12">
                    <div className="service_feature_text">
                        ...
                        <p>มีรายงานการส่งที่เจาะลึก เป็นเจ้าเดียวที่สามารถรู้ว่าผู้รับเปิดข้อความหรือไม่ <a href="">การันตีส่งถึงทุกเบอร์</a> แม้แต่เบอร์ที่แจ้งบล็อก SMS โฆษณาไว้กับเครือข่าย <span>หากส่งไม่ถึง เราพร้อมคืนเครดิตให้</span></p>
                        <div>    
                            <a
                        ...
                        <Link href="/product/otp">
                            <a className="link">อ่านเพิ่มเติมเกี่ยวกับการวัดผล SMS</a>
                        </Link>
                    </div>
                </div>
            </div>
            <div className="row align-items-center row_pad">
                ...
                <div className="col-lg-6 col-md-12 order-lg-1">
                    <div className="service_feature_text">
                        ...
                        <p>ส่ง OTP ถึงลูกค้าแบบไม่ต้องรอ พร้อม <a href="">ระบบ OTP พร้อมใช้</a> ให้นำไปส่ง OTP ได้ทันที โดยไม่ต้องเขียนโปรแกรมเพิ่ม</p>
                        <div>    
                            <a
                                href={`${process.env.NEXT_PUBLIC_WEB_URL_ACCOUNT}/register/`}
                                className="btn v2"
            ...
            <div className="row align-items-center">
                ...
                <div className="col-lg-6 col-md-12">
                    <div className="service_feature_text">
                        ...
                        <p>เชื่อมต่อกับระบบคุณด้วย <a href="">SMS API</a> เพื่อส่งข้อความแจ้งเตือนนัดหมาย แจ้งสถานะขนส่ง ฯลฯ มี SDK รองรับหลายภาษาคู่มือการใช้งานที่ทำตามได้ง่าย พร้อมทีมเทคนิคคอยตอบคำถามและช่วยแก้ปัญหาแม้อยู่นอกเวลาทำการ</p>
                        <div>    
                            <a
                                href={`${process.env.NEXT_PUBLIC_WEB_URL_ACCOUNT}/register/`}
                                className="btn v2"
                        ...
                        <Link href="/product/otp">
                            <a className="link">ดูข้อมูลที่จำเป็นสำหรับนักพัฒนา</a>
                        </Link>
                    </div>
                </div>
            </div>
