                                ...
                                {showInputstep3 && (
                                    <div className="sms_form_field">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                errrorsStep3.resultStep3
                                                    ...
                                                    <>
                                                        ...
                                                        <a
                                                            href={`${appConfig.WEB_URL_ACCOUNT}/log-in`}
                                                        >
                                                            {t(
                                            ...
                                            >
                                                {t(
                                                    'SmsSection::TestQuickregister::Try SMS sending'
                                                )}
                                            </button>
                                        </form>
                                    </div>
                        ...
                        {showModalpass && (
                            ...
                            >
                                <h5 className="pass-modal-text">
                                    {t(
                                        'SmsSection::TestQuickregister::modal::showModalpass::header'
                                    )}
                                </h5>
                                <form
                                    className="form-wrap"
                                ...
                                >
                                    <div className="form__wrapper form-password-wrap">
                                        <input
                                            ...
                                            onChange={() =>
                                                clearErrors2('resultStep2')
                                            }
                                            id="pin"
                                            name="pin"
                                            type="password"
                                            placeholder={t(
                                                'SmsSection::TestQuickregister::modal::showModalpass::placeholder'
                                            )}
                                        ...
                                        >
                                            {t(
                                                'SmsSection::TestQuickregister::modal::showModalpass::submitBtn'
                                            )}
                                        </button>
                                    </div>
                                </form>
                        ...
                        {showLogin && (
                            ...
                            >
                                <h5 className="login-topic">
                                    {t(
                                        'SmsSection::TestQuickregister::modal::showLogin::header'
                                    )}
                                </h5>
                                <p className="login-content">
                                    {t(
                                        'SmsSection::TestQuickregister::modal::showLogin::decs1'
                                    )}
                                </p>
                                <p className="login-content">
                                    {t(
                                        'SmsSection::TestQuickregister::modal::showLogin::decs2'
                                    )}
                                </p>
                                <button
                                ...
                                >
                                    {t(
                                        'SmsSection::TestQuickregister::modal::showLogin::submitBtn'
                                    )}
                                </button>
                            </div>
                        )}
