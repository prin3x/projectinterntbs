...
const listItemSMS = [
  ...
  { question: 'สามารถส่ง SMS ไปยังต่างประเทศได้หรือไม่', answer: 'เราให้บริการส่ง SMS ไปต่างประเทศที่ครอบคลุม 200 ประเทศ สามารถสอบถามอัตราค่าบริการหรือรายละเอียดเพิ่มเติม ได้ที่ <a href="mailto:contact@thaibulksms.com"><!--email_off-->contact@thaibulksms.com<!--/email_off--></a> หรือโทร. <a href="tel:027986000">0-2798-6000</a>' }
]
...
const listItemshopping = [
  ...
  { question: 'ต้องการขอใบกำกับภาษี ต้องทำอย่างไร', answer: 'สามารถทำได้ โดยการส่ง ชื่อ Username และรายละเอียดบริษัท พร้อม ชื่อ ที่อยู่ หมายเลขประจำตัวผู้เสียภาษีที่ต้องการ จัดส่งมาทาง E-mail : <a href="mailto:contact@thaibulksms.com"><!--email_off-->contact@thaibulksms.com<!--/email_off--></a>' }
]
