                    ...
                    >
                        ...
                        <div className="item">
                            <div className="slider_item">
                                <h3>
                                    {t(
                                        'SliderSection::Notification of expiry date'
                                    )}
                                </h3>
                                <p>
                                    {t(
                        ...
                        <div className="item">
                            <div className="slider_item">
                                <h3>
                                    {t(
                                        'SliderSection::Sending identity verification OTP'
                                    )}
                                </h3>
                                <p>
                                    {t(
                        ...
                        <div className="item">
                            <div className="slider_item">
                                <h3>
                                    {t(
                                        'SliderSection::Notification of delivery status'
                                    )}
                                </h3>
                                <p>
                                    {t(
                        ...
                        <div className="item">
                            <div className="slider_item">
                                <h3>
                                    {t(
                                        'SliderSection::Promotion of marketing activities'
                                    )}
                                </h3>
                                <p>
                                    {t(
