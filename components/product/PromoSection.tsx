                    ...
                    <div className="promo_item">
                        ...
                        <div className="promo_img">
                            ...
                            <div className="btnFeatureP">
                                ...
                                <a
                                    href={`${process.env.NEXT_PUBLIC_DOMAIN_URL}/product/smart-sms-console/`}
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4 col-12">
                            <div className="service_feature_item">
                                ...
                                <p>
                                    {t(
                                        'PromoSection::Know your campaign’s conversion rate.'
                                    )}
                                </p>
                            </div>
                        </div>
                        <div className="col-md-4 col-12">
                            <div className="service_feature_item">
                                ...
                                <p>
                                    {t(
                                        'PromoSection::Use the data to conduct lead scoring.'
                                    )}
                                </p>
                            </div>
                        </div>
                ...
                <div className="col-lg-6 col-md-12">
                    <div className="service_feature_text">
                        ...
                        <Link href="/product/otp">
                            <a className="link">
                                {t(
                                    'PromoSection::Read more about OTP Ready-to-Use>'
                                )}
                            </a>
                        </Link>
                        <h6
