            ...
            <div className="row m-80">
                ...
                <div className="col-md-6">
                    <div className="track_text mt-5">
                        ...
                        <p>เรามีทีมซัพพอร์ตคนไทยคอยให้ความช่วยเหลือแม้นอกเวลาทำการ ติดต่อง่ายกว่า ไม่มีอุปสรรคด้านการสื่อสาร จึงแก้ปัญหาได้เร็วกว่า ทั้งนี้การให้บริการของเรายังได้มาตรฐานระดับโลก จากการที่เรามี <a href={`${process.env.NEXT_PUBLIC_DOMAIN_URL}/product/global-sms/`}>บริการส่ง SMS ไปต่างประเทศ</a></p>
                    </div>
                </div>
            </div>
        </div>
