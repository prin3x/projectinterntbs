            ...
            <div className="row">
                <div className="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12">
                    <div className="simple_icon_title">
                        <h3>
                            {t(
                                'BrandSection::A leading, trustworthy brand: ThaiBulkSMS'
                            )}
                        </h3>
                    </div>
                </div>
                ...
                <div className="col-md-4 whyTBS">
                    <div className="single_feature_item">
                        ...
                        <div className="single_feature_text">
                            <h4>
                                {t(
                                    'BrandSection::3 direct networks can be used for sending'
                                )}
                            </h4>
                            <p>
                                {t(
                ...
                <div className="col-md-4 whyTBS">
                    <div className="single_feature_item">
                        ...
                        <div className="single_feature_text">
                            <h4>
                                {t(
                                    'BrandSection::Automatic selection of the best channel'
                                )}
                            </h4>
                            <p>
                                {t(
