      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="promo_text">
            ...
            ></h2>
            <p>{t('PromoSection::The user experience is designed to meet your requirements.')}</p>
          </div>
        </div>
      </div>
      <div className="row">
        ...
        <div className="col-md-6">
          <div className="promo_item">
            <div className="promo_title">
              <p
                dangerouslySetInnerHTML={{
                  __html: t('PromoSection::xxxxxxxxxxxxxxxx'),
                }}
              ></p>
            </div>
            <div className="promo_img">
      ...
      <div className="row align-items-center row_pad">
        ...
        <div className="col-lg-6 col-md-12">
          <div className="service_feature_text">
            <h3>{t('PromoSection::Instant credit refunds if messages fail to reach the recipients')}</h3>
            <p
              dangerouslySetInnerHTML={{
      ...
      <div className="row align-items-center row_pad">
        <div className="col-lg-5 col-md-12 col-12">
          <div className="service_feature_text">
            ...
            ></h3>
            <p>{t('PromoSection::Instantly follow through on customers or target groups after pressing send. Also possible to check whether or not the recipient has read your messages.')}</p>
            <Link href="/product/sms-tracking">
              <a className="link">{t('PromoSection::How does SMS tracking work?')}</a>
            </Link>
          </div>
        </div>
            ...
            <div className="col-md-4 col-12">
              <div className="service_feature_item">
                <img
                  ...
                  alt="Image"
                />
                <p>{t('PromoSection::Know who has or has not opened your messages.')}</p>
              </div>
            </div>
            <div className="col-md-4 col-12">
              <div className="service_feature_item">
                <img
                  ...
                  alt="Image"
                />
                <p>{t('PromoSection::Know your campaign’s conversion rate.')}</p>
              </div>
            </div>
            <div className="col-md-4 col-12">
              <div className="service_feature_item">
                <img
                  ...
                  alt="Image"
                />
                <p>{t('PromoSection::Use the data to conduct lead scoring.')}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row align-items-center">
        ...
        <div className="col-lg-6 col-md-12">
          <div className="service_feature_text">
            ...
            ></h3>
            <p>{t('PromoSection::Helping developers to work more easily and conveniently. The initial set-up requires just a few clicks, then the codes for using with API will instantly be ready.')}</p>
            <a
              href={`${process.env.NEXT_PUBLIC_WEB_URL_ACCOUNT}/register/`}
              className="btn v2"
            >
            ...
            <Link href="/product/otp">
              <a className="link">{t('PromoSection::Read more about OTP Ready-to-Use>')}</a>
            </Link>
            <h6
              className="promo_link"
              dangerouslySetInnerHTML={{
