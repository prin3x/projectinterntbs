                    ...
                    <div className="pricing_box productPage">
                        ...
                        <ul className="pricing_feature">
                            <li>
                                ...
                                <p>
                                    {t(
                                        'PricingSection::Cheaper prices for SMS sending'
                                    )}
                                </p>
                            </li>
                            <li>
                                ...
                                <p>
                                    {t(
                                        'PricingSection::Sending reports are available.'
                                    )}
                                </p>
                            </li>
                            <li>
                                ...
                                <p>
                                    {t(
                                        'PricingSection::All basic features are available.'
                                    )}
                                </p>
                            </li>
                            <li>
                        ...
                        <div className="price_bottom_text">
                            ...
                            <ul>
                                <li>
                                    {t(
                                        'PricingSection::Those who focus on high amounts of SMS sending'
                                    )}
                                </li>
                                <li>
                                    {t(
                                        'PricingSection::Those who prioritize the price'
                                    )}
                                </li>
                                <li>
                                    {t(
                                        'PricingSection::Those at the early stages of usage'
                                    )}
                                </li>
                                <li>
                                    {t(
                                        'PricingSection::Those who constantly update the database of recipients’ phone numbers'
                                    )}
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="pricing_box productPage coperateRate">
                        ...
                        <ul className="pricing_feature">
                            <li>
                                ...
                                <p>
                                    {t(
                                        'PricingSection::Every feature of Standard SMS'
                                    )}
                                </p>
                            </li>
                            <li>
                                ...
                                <p>
                                    {t(
                                        'PricingSection::A ready-to-use OTP sending system'
                                    )}
                                </p>
                            </li>
                            <li>
                        ...
                        <div className="price_bottom_text">
                            ...
                            <ul>
                                <li>
                                    {t(
                                        'PricingSection::Those looking to send OTP or transactional SMS'
                                    )}
                                </li>
                                <li>
                                    {t(
                                        'PricingSection::Those looking to send OTP without having to set up their own system'
                                    )}
                                </li>
                                <li>
                                    {t(
                                        'PricingSection::Those wishing to know whether or not the messages have reached the recipients'
                                    )}
                                </li>
                            </ul>
                        </div>
            ...
            <div className="row">
                <div className="col-md-12">
                    <div className="pricing_bottom_text">
                        ...
                        <h3>
                            {t(
                                'PricingSection::Not sure yet which package to choose? We can offer you a free SMS sending trial.'
                            )}
                        </h3>
                        <a
